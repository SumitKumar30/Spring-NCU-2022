...
<body>
	...
	<h2> Aadhar Verification Registration Form </h2> <br>
	...
	<form:input type="text" path="registrationCode" /> 
	<form:errors path="registrationCode" cssClass="error"/><br><br>
	...
	<h2>Take me to another form</h2>
	<a href = "/spring_mvc_app/home/inputForm" >Another Input form</a>
</body>
</html>